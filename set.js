...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~66Fp1et1LOZtlChyJ6JX", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "918910051810", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "ＤＡＲＫ⚔ＫＩＬＬＥＲ", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "ＤＡＲＫ⚔ＫＩＬＬＥＲ", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "ＤＡＲＫ⚔ＫＩＬＬＥＲ", // Added // Input Yours custom...
